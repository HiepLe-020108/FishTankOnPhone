...
namespace Zindeaxx.SoundSystem
{
    ...
    public class SoundManager : MonoBehaviour
    {
        ...
        /// <returns></returns>
        public AudioClip PlaySound(AudioClip audio, string VolumeID, float Secondaryvolume, bool looped, float MinDistance = 1, float MaxDistance = 500, float pitch = 1, int Priority = 128, float SpatialBlend = 1, bool spatialized = false, bool spatializePost = false)
        {
