...
namespace Lean.Touch
{
	...
	public class LeanPinchCamera : MonoBehaviour
	{
		...
		public float Zoom { set { zoom = value; } get { return zoom; } } [SerializeField] private float zoom = 50.0f;
		...
		public float ClampMin { set { clampMin = value; } get { return clampMin; } } [SerializeField] private float clampMin = 10.0f;

		/// <summary>The maximum FOV/Size we want to zoom to.</summary>
		public float ClampMax { set { clampMax = value; } get { return clampMax; } } [SerializeField] private float clampMax = 60.0f;
		...
		{
			var factor = CwHelper.DampenFactor(Mathf.Abs(direction), Time.deltaTime);
		...
		protected virtual void LateUpdate()
		{
			...
			//set currentZoom value to a limit value
			// Set the new zoom
			SetZoom(currentZoom);
...
namespace Lean.Touch.Editor
{
	...
	public class LeanPinchCamera_Editor : CwEditor
	{
