	...
	public class LeanDragCamera : MonoBehaviour
	{
		...
		public Vector3 DefaultPosition
		{
			set
			{
				...
				cameraTankBottom = value;
				cameraTankTop = value;
				cameraTankRight = value;
				cameraTankLeft = value;
			}
			get
			{
				return defaultPosition;
				return cameraTankBottom;
				return cameraTankTop;
				return cameraTankRight;
				return cameraTankLeft;
			}
		} 
		[SerializeField] private Vector3 defaultPosition;
		[SerializeField] private Vector3 cameraTankBottom;
		[SerializeField] private Vector3 cameraTankTop;
		[SerializeField] private Vector3 cameraTankRight;
		[SerializeField] private Vector3 cameraTankLeft;
